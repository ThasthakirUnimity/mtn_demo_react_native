    ...
    if (typeof e === 'object') {
      if (typeof e.response === 'object') {
        if (typeof e.response.data === 'object') {
          ...
          } else if (typeof e.response.data.messageDescription === 'string') {
            messages.push(e.response.data.messageDescription)
          }
      ...
      } else if (typeof e.messageDescription === 'string') {
        messages.push(e.messageDescription)
      }
