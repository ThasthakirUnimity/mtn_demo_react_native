...
import challengeList from './data/challenge'

import Participate from './Participate'
import participateList from './data/participate'
...
import popularList from './data/popular'

import Cashback from './Cashback'
import cashbackList from './data/cashback'
...
import Win from './Win'
import winList from './data/win'

import Recharge from './Recharge'
import rechargeList from './data/recharge'

import Postpaid from './Postpaid'
import postpaidList from './data/postpaid'
...
class GoldenCoin extends React.Component {
  constructor (props) {
    ...
    this.fetchWinList = this.fetchWinList.bind(this)
  ...
  async componentDidMount () {
    ...
    if (this.props.session.isLoggedIn) {
      ...
      if (this.props.session.user.profileImage && this.props.session.user.profileImage != 'uploads/profile/image/null') {
        await this.promisedSetState({
  ...
  async fetchWinList () {
    ...
    const list = await request(winList)
    await this.promisedSetState({
      wins: list,
      fetchingWins: false
    })
  ...
  async fetchProfileData () {
    ...
    if (list.userProfile.Badges.length) {
      await this.promisedSetState({
        profileBadge: list.userProfile.Badges[list.userProfile.Badges.length - 1]
      })
    }
        ...
        <Content style={theme.layout}>
          ...
          >
            ...
            <Participate
              ...
              flag_type='participatetowin'
              flag_title='Participate to Win'
            />
            ...
            <Offer
              ...
              flag_type='activeoffers'
              flag_title='Active Offers'
            />
            <Rewards
              language={this.state.language}
            ...
            <Shop
              ...
              flag_type='onlineshopping'
              flag_title='Online Shopping'
            />
            <Popular
              language={this.state.language}
              list={this.state.populars}
              fetching={this.state.fetchingPopulars}
              flag_type='subscriptions'
              flag_title='Popular Subscriptions'
            />
            ...
            <Cashback
              ...
              flag_type='cashbackpoints'
              flag_title='Cashback Points'
            />
            ...
            <Wallet
              ...
              flag_type='momo_wallet_offer'
              flag_title='Momo Wallet Offer'
            />
            <Image source={require('@asset/images/cashback.png')} style={styles.cashbackBanner} />
            ...
            <Recharge
              ...
              flag_type='recharge_bills'
              flag_title='Recharge & Bills'
            />
            <Postpaid
              language={this.state.language}
              list={this.state.postpaids}
              fetching={this.state.fetchingPostpaids}
              flag_type='postpaidoffers'
              flag_title='Postpaid Offers'
            />
          </ScrollView>
