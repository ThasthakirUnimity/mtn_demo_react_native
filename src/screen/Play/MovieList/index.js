...
class MovieList extends Component {
  constructor (props) {
    ...
    if (props.route.params.type == 'trending') {
      this.state.title = 'Trending'
    } else if (props.route.params.type == 'movie') {
      this.state.title = 'Movie'
    } else if (props.route.params.type == 'music') {
  ...
  async fetchList () {
    try {
      ...
      const r = (await httpMovie.get(URLS.MOVIE_LIST)).data
      ...
      <Container>
        ...
        <Content>
          <List
            ...
            pageType={this.props.route?.params?.type}
