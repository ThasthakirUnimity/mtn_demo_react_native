...
class Player extends React.PureComponent {
    ...
    open() {
        ...
        let code = null
        let image = null
        if (this.props.walkthroughSelected) {
            if (this.props.walkthroughSelected.field_video_embed?.site == 'youtube') {
                try {
                    code = this.youtubeParser(this.props.walkthroughSelected.field_video_embed.url)
                    type = 'youtube'
                } catch (e) { }
            } else if (this.props.walkthroughSelected.thumbnail_image) {
                image = this.props.walkthroughSelected.thumbnail_image
                type = 'image'
            }
            if (type) {
                this.refModal.open()
