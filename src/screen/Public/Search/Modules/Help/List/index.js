...
const List = ({ fetchingInitial, fetchingMore, list, onClick }) => {
  const renderItem = ({ item }) => (<Item item={item} onClick={onClick} />)
      ...
      <View style={styles.hashtagContainer}>
        <View>
          <View style={styles.hashtagHeader}>
            <Text style={styles.hashtagHeaderTitle}>{__('Help & Support')}</Text>
          </View>
