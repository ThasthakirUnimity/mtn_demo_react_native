...
const List = ({ fetchingInitial, fetchingMore, list, openView, buyNow }) => {
  const renderItem = ({ item }) => (<Item item={item} openView={openView} buyNow={buyNow} />)
      ...
      <View style={styles.hashtagContainer}>
        <View>
          <View style={styles.hashtagHeader}>
            <Text style={styles.hashtagHeaderTitle}>{__('Bundles')}</Text>
          </View>
