...
const ProductList = ({ tab, isSearch, fetchingInitial, fetchingMore, list, total, defaultPageLimit, searchTypeIds, changeTabByIndex }) => {
    ...
    viewMore = (
      <View style={styles.viewMore}>
        <Button style={styles.viewBtn} onPress={() => changeTabByIndex(searchTypeIds.POST)}>
          <Text style={styles.viewBtnText}>{__('View more')}</Text>
        </Button>
      </View>
    )
  }
      ...
      <View style={styles.hashtagContainer}>
        <View>
          <View style={styles.hashtagHeader}>
            <Text style={styles.hashtagHeaderTitle}>{__('Products')}</Text>
          </View>
